...
def validation_prompt(
    ...
    system_context_validator_template_str = """
        ...
        Prior experiences can be found in the curriculum vitae {prompt_cv}.
        ...
        Do not apply sentences that are close to this: crucial for this role.
    ...
    SYSTEM_CONTEXT_VALIDATOR_PROMPT = SystemMessagePromptTemplate(
        prompt = PromptTemplate(
            ...
            partial_variables={"format_cover_letter_messages": validator_parser.get_format_instructions()}
        )
    )
