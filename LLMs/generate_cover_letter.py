...
def cover_letter_chain(
    ...
    generate_cover_letter = create_cover_letter_prompt(
        semilarity_document_template=document_template, cv=cv, some_skills=skills, job_analysis=job_offer_analysis, matching_skills=matching_skills ) | llm_model | parser
